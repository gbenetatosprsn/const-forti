variable "access_key" {
  default = "AKIASQ45APO4VZM65FWA"
}

variable "secret_key" {
  default = "HdsbSdVRFZAutvPcFUDvDki/vWD0EGqkzGuviuSq"
  sensitive = true
}
...
variable "tgwaz1ip" {
  default = "10.160.214.64/28"
}

variable "tgwaz2ip" {
  default = "10.160.215.64/28"
}

variable "vpccidr" {
  default = "10.160.214.0/23"
}

variable "publiccidraz1" {
  default = "10.160.214.128/28"
}

variable "privatecidraz1" {
  default = "10.160.214.16/28"
}

variable "hasynccidraz1" {
  default = "10.160.214.32/28"
}

variable "hamgmtcidraz1" {
  default = "10.160.214.0/28"
}

variable "publiccidraz2" {
  default = "10.160.215.128/28"
}

variable "privatecidraz2" {
  default = "10.160.215.16/28"
}

variable "hasynccidraz2" {
  default = "10.160.215.32/28"
}

variable "hamgmtcidraz2" {
  default = "10.160.215.0/28"
}
...
variable "activeport1" {
  default = "10.160.214.132"
}

variable "activeport2" {
  default = "10.160.214.20"
}

variable "activeport3" {
  default = "10.160.214.40"
}

variable "activeport4" {
  default = "10.160.214.10"
}

variable "passiveport1" {
  default = "10.160.215.132"
}

variable "passiveport2" {
  default = "10.160.215.20"
}

variable "passiveport3" {
  default = "10.160.215.40"
}


variable "passiveport4" {
  default = "10.160.215.10"
}
